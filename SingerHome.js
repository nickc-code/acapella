$(document).ready(function(){
    ...
    $("#Soppranos").click(function(){  
        window.location.href="/Soppranos"
    })
    $("#Altos").click(function(){  
        window.location.href="/Altos"
    })
    $("#Tennors").click(function(){  
        window.location.href="/Tennors"
    })
    $("#Barritones").click(function(){  
        window.location.href="/Barritones"
    })
    $("#BeatBoxers").click(function(){  
        window.location.href="/BeatBoxers"
    })
